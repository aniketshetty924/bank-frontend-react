          ...
          <div className="p-6">
            ...
            <nav className="space-y-4">
              <div
                ...
                onClick={() => navigate(`/admin-dashboard/create-bank`)}
              >
                <FaUniversity /> Add New Bank
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/find-all-banks`)}
              >
                <FaList /> View All Banks
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/find-bank`)}
              >
                <FaSearch /> View a Bank
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/find-ledger`)}
              >
                <FaBook /> Bank Ledger
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/find-all-ledgers`)}
              >
                <FaFileAlt /> View All Ledgers
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/delete-bank`)}
              >
                <FaTrash /> Delete Bank
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/update-bank`)}
              >
                <FaEdit /> Update Bank Details
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/user-registration`)}
              >
                <FaUserPlus /> Register New User
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/find-all-users`)}
              >
                <FaUsers /> View All Users
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/find-user`)}
              >
                <FaUser /> Find User
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/delete-user`)}
              >
                <FaUserMinus /> Delete User
              </div>
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/update-user`)}
              >
                <FaUserEdit /> Update User Info
              </div>
              {/* KYC Requests in Sidebar */}
              <div
                className="flex items-center gap-3 p-2 rounded hover:bg-blue-700 cursor-pointer"
                onClick={() => navigate(`/admin-dashboard/kyc-requests`)}
              >
                <FaIdCard /> KYC Requests
              </div>
            </nav>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div>
                ...
                <p className="text-sm">
                  Search for a specific bank by details.
                </p>
              </div>
              <FaSearch size={32} />
            </div>
            ...
            >
              <div>
                ...
                <p className="text-sm">
                  Access transaction records and details.
                </p>
              </div>
              <FaBook size={32} />
            </div>
            ...
            >
              <div>
                <h2 className="text-xl font-semibold">KYC Requests</h2>
                <p className="text-sm">Manage and review KYC submissions.</p>
              </div>
              <FaIdCard size={32} />
            </div>
          </div>
